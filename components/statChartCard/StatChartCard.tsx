    ...
    return (
        <div className='flex w-full gap-3 p-4 bg-white rounded-2xl' >
            <div className='flex items-center gap-4 text-blue-500' >
                <Sale size={30} />
                <div>
                    <span>$ <strong className='text-xl font-semibold' >1,231</strong></span>
                    <p className='text-xs text-gray-400'>Total sales</p>
                </div>
                {chartData && chartOptions &&
                    <Chart options={chartOptions} series={chartData} type="area" height={100} width="100%" style={{ marginBottom: "-1rem" }} />}
